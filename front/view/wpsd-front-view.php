		...
		<form action="" method="POST" id="wpsd-donation-form-id">
			...
			<div class="wpsd_flex_con bg-white">
				...
				<?php //} 
					...
					<div class="wpsd_flex_con wpsd_is_recurring_wrapper">
					...
					<div class="wpsd_flex_con">
						...
						<!-- <div class="wpsd_flex_item w-100">
							<div class="wpsd_in_memory_of_con">
								<input type="text" required name="wpsd_in_memory_of" id="wpsd_in_memory_of" class="wpsd-text-field" placeholder="<?php esc_attr_e( $wpsd_in_memory_of_label, 'wp-stripe-donation' ); ?>">
							</div>
						</div> -->
					</div>
				</div>
				<div class="wpsd_flex_con">
					<div class="wpsd_flex_item w-100 wpsd_card_label_con">
						<b><?php _e($wpsd_card_label, 'wp-stripe-donation'); ?></b>
					</div>
					<div class="wpsd_flex_item w-100">
					...
					<div class="wpsd_flex_item w-100">
						<input type="submit" name="wpsd-donate-button" class="wpsd-donate-button" value="<?php echo $wpsdDonateButtonText; ?>">
					</div>
				</div>
		</form>
	</div>
